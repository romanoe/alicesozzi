  ...
  <div>
    ...
    <div v-if="!mobile">
          ...
          <div id="header">
            <v-row>
              ...
              <v-col cols=12 md=11 sm=1>
                ...
                <h3 class='subtitle'>FASCIATHÉRAPEUTE ET PSYCHOLOGUE, AGRÉE ASCA, RME</h3>
                <h3 class='subtitle'>Chemin des Aubépines 23</h3>
                <h3 class='subtitle'>1004 Lausanne</h3>
                <h3 class='subtitle'>021 648 7612 / 077 411 67 07</h3>
      ...
      <div class="d-none d-md-flex d-lg-flex">
        <div class="menu">
          <router-link v-for="(route, index) in router.options.routes" :key="index" :to="route.path" class="route">
            {{ route.name }}
          </router-link>
        </div>
      </div>
    ...
    <div v-else-if="mobile" id="header">
      <v-app-bar :elevation="1"  scroll-behavior="collapse elevate">
        ...
        <v-app-bar-title>
          ...
          <h3 class='subtitle'>FASCIATHÉRAPEUTE ET PSYCHOLOGUE</h3>
          <h3 class='subtitle'>AGRÉE ASCA, RME</h3>
        </v-app-bar-title>

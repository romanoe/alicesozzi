    ...
    <v-container>
      <div class="intro">
        <v-row justify="center" align="start">
          ...
          <br>
            <p><span class='text-home-page' >Proposer d'identifier les comportements et les schémas de pensée qui entravent la capacité innée du corps à s’auto réguler.
</span></p>
          </v-col>
          <v-col cols=12 md=6 sm=6>
            <v-img id="img-cabinet" src='/img/home_AliceSozzi@2x.png' aspect-ratio="1" contain></v-img>
          </v-col>
        </v-row>
      </div>
    </v-container>
<div  class = 'jaune' >
    <v-container>
      ...
      <v-col cols=12 md=4 sm=6>
        <v-img src='/img/Homme_alice_psy.png' aspect-ratio="2.5" contain></v-img>
      </v-col>
      ...
      <v-container>
        <v-row justify="center" no-gutters>
          <v-col cols=12 md=4 sm=1>
            <v-img id="img-actions" src='/img/AliceSozzi_equilibre@2x.png' aspect-ratio="1" contain></v-img>
            <br>
          ...
          <v-col cols=12 md=4 sm=1 xs=1>
            <v-img id="img-actions" src='/img/AliceSozzi_toucher@2x.png' aspect-ratio="1" contain></v-img>
              <br>
            <div class='text-mes-actions' >
          ...
          <v-col cols=12 md=4 sm=1>
            <v-img id="img-actions" src='/img/AliceSozzi_soulager@2x.png' aspect-ratio="1" contain></v-img>
  <br>
            <div class='text-mes-actions' >
    ...
    <v-container>
      <v-row justify="center">
        <v-col cols=12 md=4 sm=1>
          <v-img id="img-actions" src='/img/AliceSozzi_fatigue@2x.png' aspect-ratio="1" contain></v-img>
  <br>
          <div class='text-mes-actions' >
        ...
        <v-col cols=12 md=4 sm=1>
          <v-img id="img-actions" src='/img/AliceSozzi_restaurer@2x.png' aspect-ratio="1" contain></v-img>
  <br>
          <div class='text-mes-actions' >
        ...
        <v-col cols=12 md=4 sm=1>
          <v-img id="img-actions" src='/img/AliceSozzi_questionner@2x.png' aspect-ratio="1" contain></v-img>
  <br>
          <div class='text-mes-actions' >
